      ...
      <div className="mt-2 bg-white rounded-2xl shadow-xl p-6 w-full border-2 border-amber-200">
        ...
        <div className="space-y-3">
          ...
          <div className="flex items-start gap-3 p-3 rounded-lg bg-green-50">
            ...
            <p className="text-gray-700 flex-1">
              <span className="font-bold text-green-600">Green highlights</span> show valid moves
            </p>
          </div>
          <div className="flex items-start gap-3 p-3 rounded-lg bg-red-50">
            <span className="text-xl">3️⃣</span>
            <p className="text-gray-700 flex-1">
              <span className="font-bold text-red-600">Red pulsing</span> highlights show mandatory jumps
            </p>
          </div>
